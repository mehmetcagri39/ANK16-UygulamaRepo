...
const App = () => {
  ...
  //2.Durum = Sayfa yüklendiğinde 1 defa çalışır. Ancak bağamlılık dizisine hiçbir eleman tanımlanmadığı için değişikliğe bağlı olarak tekrar tetiklenmez. Yani sayfa yüklendiğinde sadece 1 defa çalışır bir daha çalışmaz!
  // useEffect(()=>{
  //   console.log("2.Durum useEffect Çalıştı!");
  // },[]);

  //3.Durum = Sayfa yüklendiğinde 1 defa çalışır. Bağımlılık dizisi içerisine verilen eleman/lar her değiştiğinde tekrar tetiklenir.
  // useEffect(()=>{
